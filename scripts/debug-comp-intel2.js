...
async function debugCompIntel() {
    ...
    if (!userId) {
        console.log('User not found by auth, checking users table...');
    ...
    console.log(JSON.stringify(yourSite?.facebook, null, 2)?.substring(0, 500));
    
    console.log('\n📊 Full yourSite.instagram:');
    console.log(JSON.stringify(yourSite?.instagram, null, 2)?.substring(0, 500));
}
